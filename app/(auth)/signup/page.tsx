...
export default function SignupPage() {
    return (
        ...
        >
            ...
            <motion.div
                className="relative z-10 w-full max-w-md p-8 space-y-6 overflow-hidden bg-zinc-950 rounded-lg shadow-lg border border-zinc-800"
                variants={containerVariants}
            >
                ...
                <motion.div className="text-center" variants={textVariants}>
                    <h1 className="text-4xl font-semibold tracking-tight text-[#DC2626] mb-2">Create an account</h1>
                    <p className="text-sm text-zinc-400">Create your account to start your fitness journey.</p>
                </motion.div>
                ...
                <motion.div className="text-center text-sm space-y-2" variants={textVariants}>
                    <p className="text-zinc-500">
                        ...
                        <Link href="/login" className="text-[#DC2626] hover:underline transition-colors duration-200">
                            Login
                        </Link>
                    </p>
                </motion.div>
