...
export default function Testimonials() {
    ...
    return (
        <div className={`w-full min-h-[80vh] py-16 bg-black text-white flex flex-col items-center ${arimo.className}`}>
            ...
            <h2 className="text-sm text-zinc-400 mb-3">Trusted by:</h2>
            {/* Avatars Row */}
            <div className="flex justify-center items-center mb-8">
                {testimonialsData.map((testimonial, index) => (
                    <div key={testimonial.id} className="flex flex-col items-center">
                        ...
                        >
                            <Image
                                src={testimonial.avatar || "/placeholder.svg"} // Use the imported Image object directly
                        ...
                        {activeIndex % originalLength === index && (
                            <span className="mt-2 text-xs font-medium text-white bg-zinc-800 uppercase tracking-wider py-1 px-2 rounded-[3px]">
            ...
            <div
                ref={testimonialsRef}
                className="flex overflow-x-scroll no-scrollbar w-full max-w-6xl px-4 py-4 scroll-smooth snap-x snap-mandatory items-start"
            >
